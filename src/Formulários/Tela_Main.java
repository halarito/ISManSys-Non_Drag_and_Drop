    ...
    public Tela_Main(){
        ...
        ActionListener al3 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(e.getActionCommand().equals("turma")){
                    
                    //painel3.setBackground(Color.red);
                    Tela_Turmas inst = new Tela_Turmas();
                    painel3.removeAll();
                    painel3.add(inst).setVisible(true);
        ...
        ActionListener al4 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(e.getActionCommand().equals("sair")){
                    ...
                    int q = JOptionPane.showConfirmDialog(rootPane, "Sair?", "Confirme", JOptionPane.YES_NO_OPTION);
                    
                    if(q == JOptionPane.YES_NO_OPTION){
        ...
        ActionListener al5 = new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if(e.getActionCommand().equals("sobre")){
                    ...
                    Tela_Sobre inst = new Tela_Sobre();
                    painel3.removeAll();
                    painel3.add(inst).setVisible(true);
